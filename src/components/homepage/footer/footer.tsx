...
const Footer = () => {
  ...
  const [dynSettings, setDynSettings] = React.useState<any>(null);
          ...
          <div className="flex-1 text-left w-full md:w-auto pt-2 md:pt-0">
            ...
            <ul className="space-y-2 text-xs text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <span>{dynSettings?.org_address || t("contactInfo.address")}</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href={`tel:${dynSettings?.org_phone || "+94771050867"}`} className="hover:text-cyan-500 transition duration-150">
                  {dynSettings?.org_phone || t("contactInfo.phone")}
                </a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 shrink-0 text-cyan-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href={`mailto:${dynSettings?.org_email || "support@clinecxa.lk"}`} className="hover:text-cyan-500 transition duration-150">
                  {dynSettings?.org_email || t("contactInfo.email")}
                </a>
              </li>
            </ul>
          </div>
