      ...
      const fetchDoctors = async () => {
        ...
        try {
          ...
          const mapped = res.data.practitioners.map((p: any) => ({
            ...
            fee: 950 + (p.price || 0), // Fallback for price
            currency: 'LKR',
            rating: { overall: 4.8 },
          }));
          setDoctors(mapped);
              ...
              {doctors.map((doctor:any) => {
                ...
                return (
                  <div
                    ...
                    className={`relative flex flex-col rounded-[2rem] border-2 transition-all duration-500 cursor-pointer overflow-hidden group ${
                      isSelected
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="relative">
                          <img
                            ...
                            alt={doctor.name}
                            className={`w-20 h-20 rounded-2xl object-cover border-2 transition-all ${
                                isSelected ? 'border-teal-300 shadow-md' : 'border-slate-50'
                            }`}
                          />
